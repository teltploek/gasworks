...
class ContactPage<T extends IContactPageProps> extends React.Component<T, IContactPageState> {
	...
	public render() {
		return (
			<Layout>
				<SEO title="Kontakt os - Gasworks, kontorfælleskab på Vesterbro" keywords={[`kontorfælleskab`, `egen plads`, `eget skrivebord`]} />
				
				<PageTitle title="Kontakt" />

				<Grid container direction="column" justify="center" alignItems="center" className={this.props.classes.wrapper}>
					...
					<Grid item xs={12} sm={6}>
						...
						<Grid item xs={12} sm={6}>
							<div className={this.props.classes.inputGroup}>
								<input className={this.props.classes.inputField} type="text" name="name" required onChange={this.handleChange} value={this.state.name} autoComplete="off" />
						...
						<Grid item xs={12} sm={6}>
							<div className={this.props.classes.inputGroup}>
								<input className={this.props.classes.inputField} type="email" name="email" required onChange={this.handleChange} value={this.state.email} />
						...
						<Grid item xs={12} sm={6}>
							<div className={this.props.classes.inputGroup}>
								<textarea className={this.props.classes.messageField} name="message" required onChange={this.handleChange} />
